...
public class Splash implements Screen {
    ...
    public void show() {
        ...
        table.add(selectBrain1).size(150, 60).padBottom(20).padRight(20);
        table.add(selectWorld).size(150, 60).padBottom(20).padRight(20);
        table.add(selectBrain2).size(150, 60).padBottom(20).row();
        table.add(brain1Label).size(200, 40).padBottom(20).padRight(20);
        table.add(worldLabel).size(200, 40).padBottom(20).padRight(20);
